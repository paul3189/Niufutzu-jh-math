...
(function () {
  ...
  var TOPICS = [
    ...
    { id: "solid.space",      d: "立體圖形與測量", n: "空間中的關係與截面", g: 9 },
  ...
  GEO = GEO.concat([
    ...
    ["solid.space", 9, "從正前方、正上方、正側方看一個立體所畫出的圖，合稱為？",
      "三視圖", ["透視圖", "展開圖", "截面圖"],
      "三視圖只記錄輪廓與長度，不畫遠近變形"],
    ["solid.space", 9, "空間中兩條<b>不平行也不相交</b>的直線稱為？",
      "歪斜線（不共面）", ["平行線", "垂直線", "重合的直線"],
      "平面上只有平行或相交，空間中多了「不共面」這個情形"],
    ["solid.space", 9, "$n$ 角柱有幾個<b>面</b>？",
  ...
  KEYWORD = KEYWORD.concat([
    ...
    ["solid.space", 9, "題目給三視圖要還原立體形狀", "先由俯視圖決定底面排列，再用前視／側視圖決定高度",
