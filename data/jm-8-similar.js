  ...
  topics: [

    {
      ...
      tools: [
        ...
        {
          n: "畢氏定理的面積證明",
          f: "\\begin{aligned}&\\text{大正方形} \\\\ &=\\text{小正方形}+4\\times\\text{直角三角形}\\end{aligned}",
          w: "理解「為什麼」成立；也是常見的拼圖型考題。",
          l: "中間傾斜的正方形邊長就是斜邊 $c$。",
          fig: "pyth-proof",
          t: "把中間正方形的邊長當成 $a-b$ 以外的東西亂寫。"
        },
        {
          n: "畢氏定理的逆定理",
          f: "a^2+b^2=c^2 \\Rightarrow \\text{是直角三角形}",
          w: "判斷三邊長能不能圍成直角三角形。",
          l: "要用「最長邊」當 $c$；$a^2+b^2>c^2$ 是銳角、$<$ 是鈍角。",
          fig: "pyth-345",
          t: "隨便挑一邊當 $c$ 就下結論。"
        },
        {
...

    {
      ...
      tools: [
        ...
        },
        {
          ...
          w: "已知兩底求中線，或已知中線與一底求另一底。",
          l: "中線連的是「兩腰的中點」，且平行於兩底。",
          fig: "trap-midseg",
          t: "把中線寫成兩底相減的一半。"
        },
        {
        ...
        {
          n: "周長比、面積比、體積比",
          f: "\\begin{aligned}&\\text{邊長比}=k \\\\ &\\Rightarrow \\text{周長比}=k \\\\ &\\text{面積比}=k^2,\\ \\text{體積比}=k^3\\end{aligned}",
          w: "地圖比例尺、模型與實物、放大縮小的題目。",
          l: "面積比是「平方」不是「兩倍」；由面積比反推邊長比要開根號。",
          fig: "sim-ratio",
          t: "邊長變 2 倍就說面積變 2 倍。"
        }
      ]
